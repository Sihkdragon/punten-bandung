<template>
    <nav class="hidden md:block absolute right-3 2xl:right-6 border-2 bg-white shadow top-32 xl:top-28 border-slate-300 rounded-sm px-1 2xl:px-2 py-4 mt-10 w-fit z-10"
